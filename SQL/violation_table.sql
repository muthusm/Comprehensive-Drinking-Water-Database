...
LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/VIOLATION_TABLE.csv'
...
COMPL_PER_BEGIN_DATE = IF(@COMPL_PER_BEGIN_DATE = '', NULL, STR_TO_DATE(@COMPL_PER_BEGIN_DATE, '%m/%d/%Y')),
COMPL_PER_END_DATE = IF(@COMPL_PER_END_DATE = '', NULL, STR_TO_DATE(@COMPL_PER_END_DATE, '%m/%d/%Y')),
...
CALCULATED_RTC_DATE = IF(@CALCULATED_RTC_DATE = '', NULL, STR_TO_DATE(@CALCULATED_RTC_DATE, '%m/%d/%Y')),
...
VIOL_FIRST_REPORTED_DATE = IF(@VIOL_FIRST_REPORTED_DATE = '', NULL, STR_TO_DATE(@VIOL_FIRST_REPORTED_DATE, '%m/%d/%Y')),
VIOL_LAST_REPORTED_DATE = IF(@VIOL_LAST_REPORTED_DATE = '', NULL, STR_TO_DATE(@VIOL_LAST_REPORTED_DATE, '%m/%d/%Y'));